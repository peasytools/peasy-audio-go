// Demo script for peasy-audio-go — PeasyAudio API client.
...
import (
	...
	peasy "github.com/peasytools/peasy-audio-go"
)
...
func main() {
	...
	fmt.Println("\n=== Search: 'convert' ===")
	results, err := client.Search(ctx, "convert")
	if err != nil {
		log.Fatal(err)
	}
